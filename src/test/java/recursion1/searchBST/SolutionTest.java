...
public class SolutionTest {
    ...
    public void testSolution(){
        ...
        /*recursion1.Solution.TreeNode treeNode = new recursion1.Solution.TreeNode(4);
        treeNode.left = new recursion1.Solution.TreeNode(2);
        treeNode.right = new recursion1.Solution.TreeNode(7);

        treeNode.left.left = new recursion1.Solution.TreeNode(1);
        treeNode.left.right = new recursion1.Solution.TreeNode(3);*/
        ...
        //recursion1.Solution.TreeNode node = solution.searchBST(treeNode, 2);
